...
[![실제 PreApp 피드백 루프: 사람의 피드백이 agent로 돌아갑니다](docs/media/preapp-dogfood-poster.png)](https://github.com/serrendypity/preapp-agent/raw/main/docs/media/preapp-dogfood-case.mp4)

> **실제 실행 1회**([▶ 재생, 41초, 무음](https://github.com/serrendypity/preapp-agent/raw/main/docs/media/preapp-dogfood-case.mp4)): 리뷰어가 특정 HTML 상태에 피드백을 남기고, 담당자가 수정 목록으로 정리했으며, agent가 이를 읽어 같은 링크에 다음 버전을 게시했습니다. **4개 버전 · 2회 리뷰 루프 · 6개 피드백 · 2개 적용된 brief.**
